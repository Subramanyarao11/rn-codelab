...
export function ResizeHandle({ direction, className }: ResizeHandleProps) {
  return (
    <PanelResizeHandle
      className={cn(
        'group relative z-10 flex-shrink-0 bg-app-border transition-colors',
    ...
    >
      <span
        className={cn(
          'pointer-events-none absolute rounded-full bg-app-fg-subtle opacity-0 transition-opacity group-hover:opacity-100 group-data-[resize-handle-active]:bg-amber-400 group-data-[resize-handle-active]:opacity-100',
